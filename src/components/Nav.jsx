          ...
          {isMobileMenuOpen && (
            <div className="absolute top-full mt-2 w-60 bg-white shadow-xl rounded-lg overflow-hidden transition-all transform translate-x-[-50%] left-[50%] opacity-100 scale-100"
              ...
              <ul className="flex flex-col space-y-2 p-4 divide-y divide-gray-200">
                ...
                <li className="pt-4">
                  <a href='/' className='font-monserrat leading-normal text-lg text-slate-gray block py-2 hover:bg-gray-100 font-semibold'>Sign in</a>
                </li>
                
                <li>
                  <a href='/' className='font-monserrat leading-normal text-lg text-slate-gray block py-2 hover:bg-gray-100 font-semibold'>Sign up</a>
                </li>
              </ul>
            </div>
          )}
